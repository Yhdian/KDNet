...
def get_optimizer_part(cfg, model):
   
    # for name, param in model.state_dict().items():
    #     if 'conv3x3_ocr_pose' in name or 'final_layer' in name:
    #         param.requires_grad = False
    for name, param in model.state_dict().items():
        if 'conv3x3_ocr' in name or 'final_layer_seg' in name:
            param.requires_grad = False
    # for name, param in model.state_dict().items():
    #     if name=='conv3x3_ocr' or name=='final_layer_seg':
    #         param.requires_grad = False
        #else:
